...
export const useFavoritosStore = defineStore('favoritos', () => {
    ...
    function existeFavorito(){
        const favoritosLocaleStorage = JSON.parse(localStorage.getItem('favoritos')) ?? []
        return favoritosLocaleStorage.some(favorito => favorito.idDrink === bebidas.receta.idDrink)
    }
